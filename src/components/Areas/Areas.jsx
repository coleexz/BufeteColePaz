...
const Areas = () => {
  ...
  return (
    <div className = "bg-gradient-to-r from-[#FFCFDF] via-[#F3D1DC] via-[#C6D8FF] via-[#D4E157] via-[#B2EBF2] via-[#FFD3B6] via-[#C5E1A5] via-[#A7C5EB] via-[#E6E6FA] via-[#FAD6A5] via-[#FFB6C1] to-[#B5EAD7] bg-400% animate-gradient">

        <div className="w-screen h-fit  pt-12 overflow-hidden py-10">
        {/* Title Section */}
