  ...
  return (
    <div className="w-screen h-fit bg-[#e0e1dd] pt-12 overflow-hidden py-10">
      ...
      <div className="flex flex-col h-10 w-screen items-center justify-center">
        <h1 className="text-lg py-4 font-bold text-[#B69D74]">
          HOW CAN WE HELP YOU?
        </h1>
      ...
      <div className="flex justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-16">
          {areas.map((area, index) => (
            ...
            >
              <div className="w-[22rem] h-[20rem] lg:w-[30rem] lg:h-[30rem] pt-8 lg:pt-0 bg-[#212121] hover:bg-[#C4B08F] transition-colors duration-500 rounded-xl flex flex-col items-center justify-center shadow-lg group relative">
                {/* CURTAIN OVERLAY */}
                <motion.div
                  className="absolute top-0 left-0 w-full h-full bg-[#C4B08F] z-20"
                  variants={curtainEffect}
                  initial="initial"
                  whileInView="whileInView"
                ...
                <div className="relative flex items-center justify-center z-10">
                  ...
                  <div className="bg-[#444] rotate-45 rounded-lg p-6 lg:p-[1.7rem] shadow-md flex items-center justify-center relative z-10 transition-transform duration-700 group-hover:rotate-[405deg]">
                    <img
                      src={area.icon}
                      className="text-4xl text-[#B69D74] -rotate-45 w-10 h-10"
                    ></img>
                  </div>
                </div>

                {/* Text Content */}
                <h1 className="text-white text-2xl font-semibold mb-4 lg:pt-8 mt-8">
                  {area.name}
                </h1>
