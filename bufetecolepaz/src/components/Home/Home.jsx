...
const Home = () => {
    return (
        <div className="bg-[#5A5243] h-5/6 pt-[9.5rem] relative overflow-hidden" >
            ...
            <div className="absolute left-1/2 transform -translate-x-[12rem] top-[34.2%]">
            ...
            <div className="bg-white w-screen min-h-screen flex flex-col items-center pt-[6rem]">
                ...
                <div className="max-w-[52rem] pb-4">
                    <div className="w-screen h-max flex flex-col justify-center items-center mt-10 px-10 text-center">
                        ...
                        <h1 className="text-2xl font-bold text-[#333] pt-8">Vision</h1>
                        <p className="text-lg text-gray-600 mt-4 leading-relaxed">
